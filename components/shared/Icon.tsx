...
type IconName = 'sun' | 'moon' | 'planner' | 'academics' | 'plus' | 'edit' | 'delete' | 'link' | 'unlink' | 'chevron-left' | 'chevron-right' | 'calendar' | 'upload' | 'download' | 'x' | 'play-circle';
...
const Icon: React.FC<IconProps> = ({ name, ...props }) => {
  ...
  const icons: Record<IconName, React.ReactElement> = {
    ...
    academics: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />,
    ...
    unlink: <path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1m-2.828 5.657l-5.657-5.657" />,
